 ...
 * @author development
 */
public class ServerSockett extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(txt_recMsg);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
         ...
         try{
        java.net.ServerSocket ser = new java.net.ServerSocket(2000);
